    ...
    <>
      ...
      >
        <div className="nav-inner">
          ...
          {/* CTA */}
          <a href="#contact" className="btn-sage nav-cta-btn" style={{ display: "inline-block", padding: "11px 24px", borderRadius: "10px", fontSize: "13px", fontWeight: 500, letterSpacing: "0.01em", whiteSpace: "nowrap" }}>
